	...
	async getUserNotifications(req, res, next) {
		try {
			...
			const notifications = await knex('users_notifications')
				.select(
					"users_notifications.type", "users_notifications.social_media", "users_notifications.readed", "users_notifications.created_at",
				...
				.where('users_notifications.to_user_id', id)
